...
// adjust 0 before single digit date
             ...
             $.ajax({
                type: 'POST',
                url: `saveData.php/?clcoi=${totCECOI}&putcoi=${totPECOI}&diff=${minuspc}&pcr=${dividepc.toFixed(2)}&time=${finalDate}`,
                success: function(data) {
                    // alert(data);
...
<body>
    ...
    border-radius: 58px;"><a href="niftycoipercent.php" style='text-decoration: none;
    color: white;
    font-weight: 700;
    font-size: 15px;'>Nifty COI PERCENT</a></button>
    <button style="    height: 54px;
    width: 132px;
    background-color: orange;
    color: white;
    text-decoration: none;
    border-radius: 58px;"><a href="bankniftycoipercent.php" style='text-decoration: none;
    color: white;
    font-weight: 700;
    font-size: 15px;'>bankNifty COI PERCENT</a></button>
...
<h4>View Options Contracts for:</h4>
  ...
  <button class="btn btn-primary" type="button"><a href="bankniftyDashboard.php" style="
    text-decoration: none;
    color: white;
    font-weight: 700;
">GO</a></button>
</div>
<!-- <button><a href="bankniftyDashboard.php">GO</a></button> -->
       <br>
       <button type="submit" name="update" id="bton" class="btn btn-warning">Fetch Stocks Data</button>
<!-- <button name="update" id="bton" type="submit">Fetch Stocks Data</button> -->
